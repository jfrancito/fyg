            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-border-color panel-border-color-success">
                <div class="panel-heading">{{ $titulo }}
                  ...
                  <div class="tools tooltiptop">
                      <div class="dropdown">
                        ...
                        <a href="{{url('/comprobante-masivo-pdf')}}" 
                           class='tn btn-secondary botoncabecera tooltipcss opciones'
                           target="_blank"
                           id="descargarcomprobantemasivopdf" 
                           data-href="{{url('/comprobante-masivo-pdf')}}"
                           title="Descargar PDF">
                ...
                <div class="panel-body">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cajareporte">
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-12 abajocaja" >
                                    {!! Form::select( 'periodo', $combo_periodo, array($periodo),
                                                      [
                                                        'class'       => 'select2 form-control control input-sm' ,
                                                        'id'          => 'periodo',
                                                        'required'    => '',
                  ...
                  <div class='listajax'>
                    @include('comprobante.ajax.alistadocumentosunat')
                  </div>
                </div>
              </div>
            </div>
...
@section('script')
  ...
  <script src="{{ asset('public/js/comprobante/sunat.js?v='.$version) }}" type="text/javascript"></script>
